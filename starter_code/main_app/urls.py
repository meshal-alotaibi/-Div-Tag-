...
urlpatterns = [
    ...
    path('change_password',auth_views.PasswordChangeView.as_view(template_name='chang_pass.html'),name='change_password'),
    path('change_password_successful',auth_views.PasswordChangeDoneView.as_view(template_name='pass_done.html'),name='pass_done'),
